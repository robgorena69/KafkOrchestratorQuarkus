...
public class MaquinaEstadoEntity {
    ...
    public String toString() {
        return "MaquinaEstadoEntity [numSec=" + numSec + ", idPeticion=" + idPeticion + ", idObjetoPadre="
                + idObjetoPadre + ", topicPrincipal=" + topicPrincipal + ", idRespuesta=" + idRespuesta
                + ", topicDependiente=" + topicDependiente + ", topicCompensacion=" + topicCompensacion
                + ", estadoPeticion=" + estadoPeticion + ", estado=" + estado + "]";
    }
