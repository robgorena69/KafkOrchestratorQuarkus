...
@RequestScoped
public class OrquestaUseCaseImpl implements IOrquestadorUseCase{
    ...
    @Inject
    IVerificaPeticion verificaPeticion;
    ...
    public void direccionaOrdenes(EnvioItemsListadoEntity envioItems) {
        ...
        try {
            ...
            //iMaquinaEstadoTimer.verificaMaquinaAtendida(maquinaEstadoEntity);
    ...
    public void direccionaDebitarItems(EnvioItemsEntity envioItemsEntity) {
        ...
        try {
            ...
            verificaPeticion.verificaPeticionAtendia(maquinaEstadoEntity);
        } catch (JsonProcessingException e) {
            // TODO Auto-generated catch block
            e.printStackTrace();
        }
